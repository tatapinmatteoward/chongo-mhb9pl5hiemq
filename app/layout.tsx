...
export const metadata: Metadata = {
  ...
  description: "A simple blog offering step-by-step guides and tips for troubleshooting and fixing the most frequent errors encountered on personal computers.",
};
